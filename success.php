...
// Update the quantity of the purchased products in the items table
$update_quantity_query = "UPDATE items SET quantity = quantity - 1 WHERE id = (SELECT item_id FROM users_items WHERE user_id = $user_id LIMIT 1)";
